...
function _sample(FileAttachment){return(
...
function _simple1all(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple1(d3,sample,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple2all(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple2(d3,sample,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple3all(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _simple3(d3,sample,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["sample.json", {url: new URL("../sample.json", import.meta.url), mimeType: "application/json", toString}],
    ["output.json", {url: new URL("../output.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("sample")).define("sample", ["FileAttachment"], _sample);
  main.variable(observer("output")).define("output", ["FileAttachment"], _output);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer("simple1all")).define("simple1all", ["d3","output","drag","invalidation"], _simple1all);
  main.variable(observer("simple1")).define("simple1", ["d3","sample","drag","invalidation"], _simple1);
  main.variable(observer("drag")).define("drag", ["d3"], _drag);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer("simple2all")).define("simple2all", ["d3","output","drag","invalidation"], _simple2all);
  main.variable(observer("simple2")).define("simple2", ["d3","sample","drag","invalidation"], _simple2);
  main.variable(observer()).define(["md"], _11);
  main.variable(observer("simple3all")).define("simple3all", ["d3","output","drag","invalidation"], _simple3all);
  main.variable(observer("simple3")).define("simple3", ["d3","sample","drag","invalidation"], _simple3);
  return main;
}
